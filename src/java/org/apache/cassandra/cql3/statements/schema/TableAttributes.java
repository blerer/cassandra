...
public final class TableAttributes extends PropertyDefinitions
{
    ...
    {
        if (hasOperationsFor(Option.DEFAULT_TIME_TO_LIVE))
        {
    ...
    private TableParams build(TableParams previous)
    {
        ...
        if (!compressionOptions.isEmpty())
        {
            ...
            {
                Double crcCheckChance = getDeprecatedCrcCheckChance(compressionOptions);
        ...
        builder.crcCheckChance(getDouble(Option.CRC_CHECK_CHANCE, previous.crcCheckChance));
