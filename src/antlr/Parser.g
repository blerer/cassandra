...
relation[WhereClause.Builder clauses]
    ...
    | ids=tupleOfIdentifiers
      ( K_IN inValue=multiColumnInValues { $clauses.add(Relation.multiColumns(ids, Operator.IN, inValue)); }
      | type=relationType v=multiColumnValue {$clauses.add(Relation.multiColumns(ids, type, v)); }
      )
    | '(' relation[$clauses] ')'
    ;
